        ...
        <div class="bg-white px-4 py-3 flex items-center flex-col lg:flex-row w-full justify-between border-t border-gray-200 sm:px-6 mt-4 mb-2">
            <div class="w-full lg:w-auto flex flex-row justify-between">
                <div class="flex flex-row space-x-4 justify-center items-center">
                    <a href="{{route('admin').'?month='.((Request::get('month') ?? date('m')) - 1)}}" class="flex items-center px-2 py-2 text-gray-500 border border-gray-400 rounded-md" aria-label="@lang('pagination.previous')" aria-disabled="true">
                    ...
                    <a href="{{route('admin').'?month='.((Request::get('month') ?? date('m')) + 1)}}" class="flex items-center px-2 py-2 text-gray-500 border border-gray-400 rounded-md" aria-label="@lang('pagination.next')" aria-disabled="true">
